...
public class UnicodeConverter {
    public static void main(String[] args) throws UnsupportedEncodingException {
    	...
    	//System.out.println("\u597D\u0020\u5440\u0021");
    	//String rs="%u597D%20%u5440%21";
    	//rs=toEncodedUnicode("你 好 ", true);
    	//rs=jsCode2JavaCode(rs);
    	//System.out.println(fromEncodedUnicode(rs.toCharArray(), 0, rs.length()));
    	System.out.println(toEncodedUnicode("{id:1} ", true));
        
    }
    /**
     * 把js生成的Unicode的编码转为java形式的Unicode编码
     * 如：“好 呀！”js编码为：%u597D%20%u5440%21
     * java编码为：\u597D\u0020\u5440\u0021
     * @param code
     * @return
     */
    public static String jsCode2JavaCode(String code){
    	if(code!=null){
    		code=code.replaceAll("%u", "\\\\u");
    		code=code.replaceAll("%", "\\\\u00");
    		return code;
    	}
    	return null;
    }
